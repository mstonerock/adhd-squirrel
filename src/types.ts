...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'adhd-squirrel-hoodie',
    name: 'ADHD Squirrel Hoodie',
    price: 47.99,
    sizePricing: hoodStandard(47.99),
    description: 'Hood up. Squirrel mode activated.',
    category: 'hoodies',
    image: '/images/mockup-pending.svg',
    graphicImage: '/images/mockup-pending.svg',
    gallery: ['/images/mockup-pending.svg'],
  ...
  {
    id: 'late-diagnosed-hoodie',
    name: 'Late Diagnosed Hoodie',
    price: 47.99,
    sizePricing: hoodStandard(47.99),
    originalPrice: 65.99,
    ...
    graphicImage: '/images/products/ADHD5.jpg',
    gallery: ['/images/products/signs-hoodie.jpg'],
